...
<html lang="zh-CN">
  <head>
    ...
    <link href="<?php $this->options->themeUrl('public/css/iconfont.css'); ?>" rel="stylesheet">
    ...
    <nav class="navbar navbar-default">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a href="<?php $this->options->siteUrl(); ?>" class="navbar-brand" style="padding:0;"><img src="<?php $this->options->themeUrl('images/logo.png'); ?>" alt="<?php $this->options->title() ?>"></a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            <!-- 导航：
            链接增加格式：<li><a href="链接">名称</a></li>
             -->
          ...
          <ul class="nav navbar-nav navbar-right">
            <?php if($this->user->hasLogin()): ?>
              <li><a href="<?php $this->options->siteUrl(); ?>/admin">管理后台 (<?php $this->user->screenName(); ?>)</a></li>
            <?php endif; ?>            
          </ul>
        </div><!-- /.navbar-collapse -->
      </div><!-- /.container-fluid -->
