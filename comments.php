    ...
    <div id="<?php $comments->theId(); ?>">
        ...
        <div class="comment-main">
            ...
            <div class="comment-meta">
                <span class="<?php echo $commentAuthor; ?>"><?php $comments->author(); ?></span>
...
<div id="comments" class="cf">
    ...
    <div id="<?php $this->respondId(); ?>" class="respond">
        ...
        <form method="post" action="<?php $this->commentUrl() ?>" id="comment-form" role="form">
            ...
            <?php else: ?>
            <input type="text" name="author" maxlength="12" id="author" class="form-control" placeholder="<?php _e('昵称'); ?>" value="" required>
            <input type="email" name="mail" id="mail" class="form-control" placeholder="<?php _e('邮箱'); ?>" value="" <?php if ($this->options->commentsRequireMail): ?> required<?php endif; ?>>
            <?php endif; ?> 

            <textarea name="text" id="textarea" class="form-control" onkeydown="if(event.ctrlKey&&event.keyCode==13){document.getElementById('misubmit').click();return false};" placeholder="<?php _e('要不再想想...'); ?>" required ><?php $this->remember('text',false); ?></textarea>
